// src/IDL/pump-fun.ts - Corrected to match the working JSON
export type PumpFun = {
    ...
    instructions: [
      ...
      },
      {
        ...
        accounts: [
          ...
          {
            name: "tokenProgram";
            address: "TokenkegQfeZyiNwAJbNbGKPFXCWuBEwF6P";
          },
          {
            name: "rent";
            address: "SysvarRent111111111111111111111111111111111";
    ...
    accounts: [
      {
        name: "bondingCurve";  // ← lowercase (matches JSON)
        discriminator: [23, 183, 248, 55, 96, 216, 172, 96];
      },
      {
        name: "global";       // ← lowercase (matches JSON)
        discriminator: [167, 232, 232, 177, 200, 108, 114, 127];
      }
    ];
    events: [
      {
        name: "createEvent";    // ← lowercase (matches JSON)
        discriminator: [27, 114, 169, 77, 222, 235, 99, 118];
      },
      {
        name: "tradeEvent";     // ← lowercase (matches JSON)
        discriminator: [189, 219, 127, 211, 78, 230, 97, 238];
      },
      {
        name: "completeEvent";  // ← lowercase (matches JSON)
        discriminator: [95, 114, 97, 156, 212, 46, 152, 8];
      },
      {
        name: "setParamsEvent"; // ← lowercase (matches JSON)
    ...
    types: [
      ...
      {
        name: "createEvent";    // ← Added complete event types (matches JSON)
        type: {
          kind: "struct";
          fields: [
            {
